...
const Offer = () => {
  return (
    <div className=' hidden bg-gradient-to-b from-[#fde1ff] to-[#e1ffea22] h-auto mx-auto lg:flex flex-auto  shadow-lg border-1 rounded-lg   lg:flex-row w-[80%]'>
      ...
      <div className='flex w-full lg:w-[30%] items-center justify-center' id='offer-right'>
        <img src={exclusive_image} alt="" className='w-[200px] h-[200px] md:h-[400px]' />
      </div>
    </div>
  )
}
